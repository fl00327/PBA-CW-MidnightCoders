...
#   Multiple Linear Regression Model R File
#             November 2021
#
#           MLR to predict:
#             weight_pounds
...
main <- function(){
  ...
  #Preprocess the data
  #Normalising the data proved to reduce accuracy for linear regression, therefore remove scalinging and centering. 
  ...
  #Build the multiple linear regression model predicting weight_pounds on all other values in training dataframe. 
  ...
  #Create a new dataframe containing the true weight_pounds and guessed weight_pounds for each child in test dataset.
  ...
  #Plot a graph displaying all values with colour coding to indicate if guessed correctly or not.
